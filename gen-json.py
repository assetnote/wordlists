...
for item in filelist:
	...
	obj = OrderedDict([("Filename", item), ("Line Count", num_lines), ("File Size", file_size), ("Date", modification_time), ("Download", "<a href='https://github.com/assetnote/wordlists/raw/master/{0}{1}'>Download</a>".format(directory, item))])
